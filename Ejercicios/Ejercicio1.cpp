...
void pedirDatos()
{
    ...
    cin >> persona1.edad; cin.ignore(); // Como la edad es de tipo entero, facilmente podemos guardarlo con un "cin", la variable persona1, nos permite ingresar a la estructura
